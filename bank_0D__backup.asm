...
RUINEDCASTLE_SQ2:
    .byte TEMPO_6
    .byte SPEED_SET,$0D    ; 7 ; envelope speed
...
EARTHCAVE_SQ1:
    ...
    .byte $B4,$B9,$B9,$B4,$B9,$B9,SPEED_SET,$05,OCTAVE_4,$07
    .byte OCTAVE_3,$97,$57,$97,$B7,OCTAVE_4,$07,OCTAVE_3,$B7,$97,SPEED_SET,$08,OCTAVE_4,$24
    .byte $29,$29,OCTAVE_4,$24,$29,$29,SPEED_SET,$05,$37,$07,OCTAVE_3,$87
    .byte OCTAVE_4,$07,$27,$37,$27,$07,SPEED_SET,$08,OCTAVE_3,$A4,$A9,$A9
    .byte OCTAVE_3,$A4,$A9,$A9,SPEED_SET,$05,OCTAVE_4,$37,$07,OCTAVE_3,$87,OCTAVE_4,$07,$27
    .byte $37,$27,$07,SPEED_SET,$08,$54,$59,$59,$54,$59
    .byte $59
    .byte LOOP_FOREVER
    .word D1LOOP0
...
MATOYA_SQ1:
    ...
    .byte OCTAVE_4,$75,$67,$47,$25,$47,$27,INSTRUMENT_E,$13,INSTRUMENT_C,$27,$67
    .byte $97,$27,$B5,$97,$77,$65,$77,$67,$45,$67,$77,INSTRUMENT_E,$93,$15
    ...
    .byte OCTAVE_3,$95,INSTRUMENT_E,OCTAVE_4,$20,$C5,SPEED_SET,$04,INSTRUMENT_1,$29,$19,OCTAVE_3,$B9,OCTAVE_4
...
@UpdateLoop:
  ...
  : STA ch_envpos, X     ; write back as current env pos
   ...
   ; STA tmp+1
    ...
    ;JSR AdjustVolume
    ;; JIGS ^ inserting this! ... down here so as not to waste cycles JSR-ing!
...
Music_ApplyLength_Rest:
    ...
    LDA ch_tempo, X
    AND #$F0               ; get only the high bits (its shared!)
    CLC
    ADC #<lut_NoteLengths  ; add the above to the start of the note length luts
...
;; 00 - envelope pattern table done in 2 frames, 3rd frame forced to last value
;; 01 - envelope pattern table done in 3 frames, 4th frame forced to last value
;; 02 - done in 4 frames
;; 03 - done in 5 frames, 5th frame forced to last value?
;; 04 - done in 8 frames
;; 05 - done in 10 frames, 11th frame forced to last value?
;; 06 - done in 16 frames
;; 07 - 
;; 08 - done in 32 frames - 1 step per frame
;; 09 - 
;; 0A - 
;; 0B - 
;; 0C - 
