...
Battle_AfterFadeIn:
    ...
    ;BNE BattleLogicLoop
    BNE DynamicBattleLogicLoop
    ;; JIGS - this is BNE $4A originally... BNE $47 in the Dynamic Action patch...
    ...
    ;; JIGS - the bulk of dynamic action changes begin right here...
    
    TYA                     ; drop high byte and check low byte
    CMP #11
    BCC @Surprised
    CMP #90
    BCC DynamicBattleLogicLoop
    
   @StrikeFirst:
    LDA #BTLMSG_STRIKEFIRST
    DEC btl_strikingfirst
 	JMP :+
    
   @Surprised:
    LDA #BTLMSG_SURPRISED
    INC btl_strikingfirst
  : JSR DrawBtlMsg_ClearCombatBoxes
  
DynamicBattleLogicLoop: 
...
BattleLogicLoop:
    ...
    CMP #01
    BEQ DynamicActionThing_2
    ;; JIGS ^ dynamic action added these 
...
DoBattleRound:
  ...
  @PerformBattleTurnLoop:
    ...
    BMI @TakeTurn               ; if it's a player, take their turn
      ...
      BMI @NextTurn
      ;; JIGS - another BNE to BMI change?
...
Battle_DoPlayerTurn:
   ...
   ;; JIGS -- all this replaced with a JSR and some NOPs to keep things the same
...
Battle_PlayerTryRun:
    ...
    BMI @Success                    ; If yes, run success is guaranteed
    ;; JIGS - BNE to BMI for some reason
